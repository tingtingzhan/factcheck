...
Guards for any claim about what a party *is* or *can/can't* do: dispositional
traits, capacity vs. non-performance, capability vs. its exercise, capability
indexed to a point in time, symmetric treatment of interior/epistemic states,
and claims that a party succeeded or got away.
