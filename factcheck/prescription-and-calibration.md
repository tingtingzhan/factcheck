...
>[!caution]- Price an Arrangement on Every Ledger It Draws On
>
>Before calling a course of action **cheap, free, or already available**, list each party whose contribution it requires and price it on that party's own ledger. One party supplying their share at no charge sets the cost on **their** ledger only; an arrangement needing an input from a second party is not cheap until that input is priced too, and *offered* is not *taken up*. The tell is a cost stated without a bearer. Where a required contributor's willingness or capacity is unestablished, the arrangement's price is **undetermined**, not low — and what never happened, priced at zero, becomes a forgone choice, then a fault, with no step in between where the gap could be caught.
